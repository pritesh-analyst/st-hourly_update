...
def Getdataentries(date):
    ...
    results = f"<p style='font-size: 24px;'>Total G4 Swappings: {g4_swappings}  </p><br><p style='font-size: 24px;'>Total Unique Laptop Entries: {laptop_entries}</p>"
